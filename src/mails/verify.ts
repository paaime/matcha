...
export const verifyAccountEmail = async (user: IUser, token: string) => {
  try {
                                                ...
                                                <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                                                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                                      ...
                                                      <tr>
                                                         <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555;">
                                                               Welcome to Brand! We're excited to have you on board. Before you get started, you need to confirm your email address. Just click the button below.
                                                            </div>
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                            ...
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                               <tr>
                                                                  <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                                                     <a href="${process.env.DOMAIN}/api/verify/register?token=${token}" style="background:#2F67F6;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                                        Confirm Your Email
                                                                     </a>
                                                                  </td>
                                                               </tr>
                                                      ...
                                                      <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                                      <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555;">
                                                      <a href="${process.env.DOMAIN}/api/verify/register?token=${token}" style="color:#2F67F6">${process.env.DOMAIN}/api/verify/register?token=${token}</a>
                                                      </div>
                                                      </td>
                                                      </tr>
                                                      <tr>
...
export const verifyPasswordEmail = async (user: IUser, digit: string) => {
  try {
    const resend = new Resend(process.env.RESEND_API_KEY);
    ...
    await resend.emails.send({
      from: 'onboarding@resend.dev',
      to: user.email,
      subject: 'Brand - Change Your Password',
      html: `<!doctype html>
       <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
          <head>
             <title>
                Brand - Change Your Password
             </title>
             <!--[if !mso]><!-- -->
             <meta http-equiv="X-UA-Compatible" content="IE=edge">
             <!--<![endif]-->
                                                 ...
                                                 <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                                       ...
                                                       <tr>
                                                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                             <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555;">
                                                                You have requested to change your password. Please use the following code to change your password.
                                                             </div>
                                                          </td>
                                                       </tr>
                                                       <tr>
