...
export const subscriptionsConfirmEmail = async (
  user: IUser,
  subscription: {
    plan: string;
    price: string;
  ...
  try {
    ...
    await resend.emails.send({
      ...
      to: user.email,
      subject: 'Brand - Thank you for subscribing !',
      html: `<!doctype html>
      <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
         <head>
            <title>
               Brand - Thank you for subscribing !
            </title>
            <!--[if !mso]><!-- -->
                                                ...
                                                <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                                                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                                      ...
                                                      <tr>
                                                         <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555;">
                                                                You have successfully subscribed to our <b>${subscription.plan}</b> plan for <b>${subscription.price}.</b> Your subscription will end on <b>${subscription.endDate}.</b>
                                                            </div>
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                            ...
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                               <tr>
                                                                  <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                                                     <a href="${process.env.DOMAIN}/subscriptions" style="background:#2F67F6;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
...
export const subscriptionsEndEmail = async (
  user: IUser,
  subscription: {
    plan: string;
    price: string;
  ...
  try {
    ...
    await resend.emails.send({
      from: 'onboarding@resend.dev',
      to: user.email,
      subject: 'Brand - Your subscription has ended',
      html: `<!doctype html>
       <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
          <head>
             <title>
                  Brand - Your subscription has ended
             </title>
             <!--[if !mso]><!-- -->
             <meta http-equiv="X-UA-Compatible" content="IE=edge">
             <!--<![endif]-->
                                                 ...
                                                 <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                                       ...
                                                       <tr>
                                                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                             <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555;">
                                                                 You're subscription to our <b>${subscription.plan}</b> plan has ended. We hope you enjoyed our service.
                                                             </div>
                                                          </td>
                                                       </tr>
                                                       <tr>
